 ...
 * that maps the velocity into the 128-entry TVA curve, is exactly
 ...
 * components different windows, several as clean partitions with no
 * overlap and no gap: `Rotary Org.` 0..112 and 113..127, `Velo Harmnix`
 * 0..120 and 121..127, `Funk Gt.2` 0..115 and 116..127, `French Horns`
 * 0..100 and 101..127. libEmuSC's SC-55 path gates its partials on the
