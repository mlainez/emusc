...
const struct XpDeviceProfile JV1080_PROFILE = {
  ...
  .rhythmNoteFields = {
    ...
    /* A rhythm note has no FXM (`05_data_model/rhythm_schema.md`). */
    .fxmSwitch = XP_VOICE_FIELD_NONE,
    .fxmColor = XP_VOICE_FIELD_NONE,
    .fxmDepth = XP_VOICE_FIELD_NONE,
    .benderSwitch = XP_VOICE_FIELD_NONE,
    .holdSwitch = 0x0au,
    .benderRange = 0x06u,
    .ampVelocitySens = 0x2au,
    .ampVelocityCurve = XP_VOICE_FIELD_NONE,
    /* A rhythm note has no bias (`05_data_model/rhythm_schema.md`). */
    .biasDirection = XP_VOICE_FIELD_NONE,
    .biasPoint = XP_VOICE_FIELD_NONE,
    .biasLevel = XP_VOICE_FIELD_NONE,
  ...
  .patchFieldKeyAssign = 0x33u,
  .patchFieldSoloLegato = 0x34u,
  .patchFieldPortamentoSwitch = 0x35u,
  .patchFieldPortamentoMode = 0x36u,
  .patchFieldPortamentoType = 0x37u,
  .patchFieldPortamentoStart = 0x38u,
  .patchFieldPortamentoTime = 0x39u,
